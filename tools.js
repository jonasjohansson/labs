...
const LABS = [
  {
    name: "Apps",
    items: [
      { title: "Indigo", description: "Turns any URL into a Syphon or NDI video stream at up to 4K on macOS", url: "https://github.com/jonasjohansson/Indigo" },
      { title: "Wendigo", description: "NDI/Syphon to browser bridge, streaming video over WebSocket H.264", url: "https://github.com/jonasjohansson/wendigo" },
      { title: "Ratbat", description: "Personal radio for the Apple ecosystem, with faceted stations from Last.fm, NTS, and Bandcamp", url: "https://ratbat.jonasjohansson.se" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Testbild 360", description: "Test patterns and projection conversion for fulldome, equirectangular, and panoramic imaging", url: "https://testbild-360.jonasjohansson.se" },
      { title: "Unwrapped", description: "3D UV inspector and texture preview tool", url: "https://jonasjohansson.github.io/unwrapped/" },
      { title: "Instagram Prototype", description: "Mock Instagram profile and post demo tool", url: "https://jonasjohansson.github.io/instagram-prototype/" },
      { title: "Fulldome Preview", description: "Fulldome cinema preview tool", url: "https://preview.domedreaming.com" },
  ...
  },
  {
    ...
    items: [
      { title: "Resolume FFGL Shaders", description: "Custom ISF shaders compiled as FFGL plugins for Resolume Arena", url: "https://github.com/jonasjohansson/resolume-ffgl" },
      { title: "Organize Downloads", description: "Chrome extension that sorts downloads by date and category", url: "https://github.com/jonasjohansson/organize-downloads-by-date-and-category-chrome-extension" },
    ],
  },
  {
    name: "Resources",
    items: [
      { title: "Exploring Technology", description: "Tutorials and guides for creative technology", url: "https://www.exploring.technology" },
      { title: "Google Templates", description: "Shared templates for project structure and finance planning", url: "https://drive.google.com/drive/folders/1f9R8S7efyesHzigLx6plSazXh47Pa-OV?usp=sharing" },
    ],
  },
];
